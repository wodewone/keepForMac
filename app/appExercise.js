...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moduleExercise = __webpack_require__(658);
	...
	var ModuleExercise = (_dec = (0, _reactCssModules2.default)(_moduleExercise2.default, { allowMultiple: true }), _dec(_class = (_class2 = function (_Component) {
	    ...
	    _createClass(ModuleExercise, [{
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: __webpack_require__(660), alt: '' }),
	                        _react2.default.createElement(
	                            'p',
	                            { className: 'padding' },
	                            '\u606D\u559C\u4F60\u5B8C\u6210\u8BAD\u7EC3'
	        ...
	        value: function getSoundTips(name) {
	            return 'file://' + __webpack_require__(649).resolve() + '/build/sounds/' + name;
	        }
	    }, {
	        key: 'getSoundNumber',
	        value: function getSoundNumber(name) {
	            return 'file://' + __webpack_require__(649).resolve() + '/build/number/N' + name + '.mp3';
	        }
	    }, {
	        key: 'makeNumOrder',
