...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moduleExercise = __webpack_require__(657);
	...
	var ModuleExercise = (_dec = (0, _reactCssModules2.default)(_moduleExercise2.default, { allowMultiple: true }), _dec(_class = (_class2 = function (_Component) {
	    ...
	    _createClass(ModuleExercise, [{
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: __webpack_require__(659), alt: '' }),
	                        _react2.default.createElement(
	                            'p',
	                            { className: 'padding' },
	                            '\u606D\u559C\u4F60\u5B8C\u6210\u8BAD\u7EC3'
	        ...
	        value: function getSoundTips(name) {
	            return 'file://' + __webpack_require__(650).resolve() + '/build/sounds/' + name;
	        }
	    }, {
	        key: 'getSoundNumber',
	        value: function getSoundNumber(name) {
	            return 'file://' + __webpack_require__(650).resolve() + '/build/number/N' + name + '.mp3';
	        }
	    }, {
	        key: 'makeNumOrder',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true) {
		...
		if(!content.locals) {
			module.hot.accept(658, function() {
				var newContent = __webpack_require__(658);
