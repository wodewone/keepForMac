	    ...
	    _createClass(App, [{
	        ...
	        value: function getUser() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { styleName: 'header-avatar', src: this.state.user.avatar, alt: '' })
	            );
	        }
	    }, {
	        ...
	        value: function componentWillMount() {
	            ...
	            if (_Utils2.default.storage.get('userData')._id) {
	                // 获取登录用户信息缓存
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: 'http://staticssl.gotokeep.com/show/images/homepage/logo-ec5cad8f05.png', alt: '' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appLogin = __webpack_require__(633);
	        ...
	        value: function handleSubmit(e) {
	            ...
	            _HttpRequest2.default.login({
	                ...
	                if (response.ok) {
	                    ...
	                    _Utils2.default.storage.set('userData', _Utils2.default.string.b64decode(response.data.token.split('.')[1]));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppMenu = __webpack_require__(641);

	var _AppMenu2 = _interopRequireDefault(_AppMenu);

	var _appExplore = __webpack_require__(642);
	        ...
	        value: function handleUserInfo(userId) {
	            _HttpRequest2.default.getUserData(userId).then(function (response) {
	                if (response.ok) {
	                    ...
	                    console.info(_UserWindow2.default.check());
	                    if (_UserWindow2.default.has()) _UserWindow2.default.show();else _UserWindow2.default.create(response.data.user.username);
	                }
	            });
	        }
	    }, {
	...
	var _default = {
	    ...
	    create: function create(title) {
	        ...
	        this.winUser.on('close', function () {
	            _this.winUser = null;
	            console.info('user-window:', _this.winUser);
	        });
